...
def data_insert(data):
    ...
    for k in range(len(result1)):
        ...
        insert = "insert into time(TaskId,Times,Time,DNSTime,EstablishConnectionTime,SSLHandshakeTime," \
                 "FirstPackageTime,ClientTime,ContentDownloadTime,TotalDownloadTime,FirstScreenTime,MonitoringPoints," \
                 "ErrorPoints,Usability)values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
